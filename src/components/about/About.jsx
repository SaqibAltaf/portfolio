    ...
    <section id="about">
      ...
      <div className="container about__container">
        <div className="about__cards">
          <p>
            Hi, I'm Malik Saqib Altaf. A motivated software engineer with superior
        ...
        <div className="about__me">
          ...
          <ul className="lego_ul">
            ...
            <li style={{ "--clr": "#1da1f2", "--i": 4 }} className="lego_li">
              ...
              Cricket / Badminton / Strength Training / Pool Laps
            </li>
            <li style={{ "--clr": "#c32aa3", "--i": 3 }} className="lego_li">
              <span>
                <BiMoviePlay />
              </span>
              Ozark / Fight Club / Said The Sky
            </li>
            <li style={{ "--clr": "#ff0000", "--i": 2 }} className="lego_li">
              <span>
                <FaCoffee />
              </span>
              Pour Over / Bubble Tea / Raspberries
            </li>
            {/* #0affc2 */}
          </ul>
        </div>
